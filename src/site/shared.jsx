...
export const T18N = {
  "pt-BR": {
    ...
    footer: {
      tagline: "Crie sua fintech com tecnologia pronta para operar, escalar e evoluir.",
    ...
    home: {
      ...
      productsSubtitle: "Cada produto opera de forma independente ou combinada. Tudo modular e pronto para escalar.",
      ...
      comparisons: [
        ...
        { sem: { title: "Produtos genéricos", desc: "Produto de prateleira com cara de template. Mesma experiência pra todo mundo." }, com: { title: "Produtos customizados de verdade", desc: "Jornada, regras e visual desenhados pro seu negócio. Ninguém sabe que somos nós." } },
    ...
    products: {
      ...
      banking: { name: "JUST Banking", desc: "Conta digital, cartão, PIX, transferências. Banking completo sobre BaaS.", headerDesc: "Conta, cartão e PIX com sua marca" },
      ...
      antecipacao: { name: "JUST Credit", desc: "Private label, antecipação e recebíveis. Produtos de crédito integrados ao seu negócio.", headerDesc: "Produtos de crédito sob medida" },
    ...
    sobre: {
      ...
      intro: "A JUST nasceu em 2020 para resolver um problema simples e recorrente no mercado financeiro: promessas que não viram produto. Desenvolvemos e integramos tecnologia financeira para empresas que precisam operar com velocidade, segurança e escala.",
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            "Se você aceitar publicidade e nos enviar um formulário, seu e-mail e telefone podem ser transmitidos a essas plataformas de forma cifrada e irreversível (hash), nunca em texto legível. Isso serve apenas para que elas identifiquem qual anúncio levou você até nós e para formar públicos de divulgação. Recusando publicidade, nada disso acontece: o formulário chega somente à JUST.",
  ...
  "en": {
    ...
    footer: {
      tagline: "Launch your fintech with technology ready to operate, scale and evolve.",
    ...
    home: {
      ...
      productsSubtitle: "Each product operates independently or combined. Modular and ready to scale.",
      ...
      comparisons: [
        ...
        { sem: { title: "Generic products", desc: "Off-the-shelf product that looks like a template. Same experience for everyone." }, com: { title: "Truly custom products", desc: "Journey, rules and design tailored to your business. Nobody knows it's us." } },
    ...
    products: {
      ...
      banking: { name: "JUST Banking", desc: "Digital account, card, PIX, transfers. Complete banking on BaaS.", headerDesc: "Account, card and PIX with your brand" },
      ...
      antecipacao: { name: "JUST Credit", desc: "Private label, payroll advance and receivables. Credit products integrated into your business.", headerDesc: "Custom credit products" },
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            "If you accept advertising and submit a form, your email and phone number may be transmitted to those platforms in irreversible hashed form, never as readable text. This is used only so they can identify which ad brought you here and to build audiences. If you decline advertising, none of this happens: the form reaches JUST only.",
