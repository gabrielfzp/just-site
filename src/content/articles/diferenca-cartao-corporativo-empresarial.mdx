...
<figure>
  <img
    src="/conteudos/diferenca-cartao-corporativo-empresarial/controle-cartao-corporativo-empresarial.png"
    alt="Comparativo entre controle reativo e controle preventivo em cartão empresarial e corporativo"
    loading="lazy"
    decoding="async"
  />
  <figcaption>A diferença relevante não está no nome do cartão. Está no nível de controle antes da autorização e na qualidade da reconciliação depois da compra.</figcaption>
</figure>
